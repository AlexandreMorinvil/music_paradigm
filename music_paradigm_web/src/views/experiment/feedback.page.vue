...
export default {
	...
	methods: {
		updateFootnote() {
			let footnoteMessage = '';
			if (this.anyPianoKey) footnoteMessage = this.$t('views.experiment.feedback.footnote-press-any-key');
			else footnoteMessage = this.$t('views.experiment.feedback.footnote-press-space-bar');
