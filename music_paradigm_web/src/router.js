		...
		},
		{
			...
			children: [
				...
				},
				{
					path: 'pvt',
					name: 'experiment.pvt',
					component: () => import(/* WebpackChunkName: "experiment" */ './views/experiment/pvt.page.vue'),
				},
				{
					path: 'question',
		...
		// TODO: Guard for the admin page : verify that we are indeed an admin
		{
			...
			children: [
				...
				},
				{
					...
					component: () => import(/* WebpackChunkName: "admin" */ './views/admin/tasks-management.page.vue'),
				},
				{
					path: 'curriculums',
				...
				},
				{
					...
					component: () => import(/* WebpackChunkName: "admin" */ './views/admin/experiment-resources.page.vue'),
				},
				{
					path: 'data',
					name: 'admin.data',
