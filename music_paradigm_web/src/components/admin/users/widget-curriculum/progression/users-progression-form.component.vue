...
export default {
	...
	computed: {
		...mapGetters('managementUsers', ['userSelectedId']),
	...
	methods: {
		...mapActions('managementUsers/progressions', ['refreshSelectedUserProgression', 'setSelectedSession', 'unsetSelectedSession']),
		handleRefresh() {
