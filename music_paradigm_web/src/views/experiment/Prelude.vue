<template>
  <div id="prelude-state" class="experiment-state-container grid-area-note">
    <div id="text-area" class="experiment-state-division state-division-text">{{ textToDisplay }}</div>

    <div id="note-area" class="experiment-state-division state-division-text">{{ footnote }}</div>
  </div>
</template>
