<template>
	<admin-page-content-frame title="Experiments Resources">
...
// FIXME: Replace this component by another one
// import FileBrowserWidget from '@/components/admin/resources/widget-file-browser/file-browser.widget.vue';
