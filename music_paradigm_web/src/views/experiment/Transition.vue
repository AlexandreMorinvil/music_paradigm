<template>
<!--
    This page is a buffer page that appears instantaneously between two blocks of a flow.
    The objective of this buffer page is to force Vue to unmount a page and then remount it
