...
function updateStateSettings(currentState, targetState, isInitialized, generalSettings) {
	...
	currentState.settings = {
		...
		isReferenceSurveyAnswer:		typeof isReferenceSurveyAnswer === 'boolean'		? isReferenceSurveyAnswer : false,
		surveyCheckboxesOneVerticalLine: typeof surveyCheckboxesOneVerticalLine === 'boolean' ? surveyCheckboxesOneVerticalLine : false,
		writtingMaxCharacters: 			typeof writtingMaxCharacters === 'number' 			? writtingMaxCharacters : 0,
		writtingTextAreasNumber: 		typeof writtingTextAreasNumber === 'number'			? writtingTextAreasNumber : 1,
		writtingTextAreasMax: 			typeof writtingTextAreasMax === 'number'			? writtingTextAreasMax : 1,
		writtingTextAreasMin: 			typeof writtingTextAreasMin === 'number'			? writtingTextAreasMin : 1,
		...
		cueMelodyProportionalDelayAfter:typeof cueMelodyProportionalDelayAfter === 'number'	? cueMelodyProportionalDelayAfter : 0,
		cueAdditionalDelayAfter:		typeof cueAdditionalDelayAfter === 'number'			? cueAdditionalDelayAfter : 0,
		cueEnablePianoAfterCue:			typeof cueEnablePianoAfterCue === 'boolean'			? cueEnablePianoAfterCue : false,
