  ...
  methods: {
    ...
    getMetricAndLog() {
      ...
      const logObj = {
        ...
        expMidiFileName: this.experiment.currentMidi
      ...
      switch (this.experiment.mode) {
        ...
        case "rhythm": {
          ...
          this.experiment.feedbackStatus +=
            rhythmDiff <= config.maxRhythmError ? "s" : "w";
          ...
          const sequenceDuration = missedNoteNum
            ? 0
            : this.playedDurations[this.playedDurations.length - 1] -
              this.playedDurations[0];
