<template>
	<div class="adjustments-grid">
		<div>
			<div>
				<input class="number" v-model="currentAdjustments.adjustmentDelayInDays" name="adjustmentDelayInDays" type="number" />
				<label for="adjustmentDelayInDays"> Days adjustment to have the session available </label>
			</div>

			<div>
				<input class="checkbox" v-model="currentAdjustments.adjustmentConsiderCompleted" name="adjustmentConsiderCompleted" type="checkbox" />
				<label for="adjustmentConsiderCompleted"> Consider the session completed </label>
			</div>

			<div>
				<input class="checkbox" v-model="currentAdjustments.adjustmentPreponeAvailability" name="adjustmentPreponeAvailability" type="checkbox" />
				<label for="adjustmentPreponeAvailability"> Remove the delays planned for the session </label>
			</div>
		</div>
		<div>
			<div>
			...
			<div>
				<input class="checkbox" v-model="currentAdjustments.adjustmentImposeReadyToBeDone" name="adjustmentImposeReadyToBeDone" type="checkbox" />
				<label for="adjustmentImposeReadyToBeDone"> Ignore the order and make the session ready </label>
			</div>

			<div>
				<input class="checkbox" v-model="currentAdjustments.adjustmentOverlookUniqueInDays" name="adjustmentOverlookUniqueInDays" type="checkbox" />
				<label for="adjustmentOverlookUniqueInDays"> Allow availbility even with previous session done the same day </label>
			</div>
		</div>
		<div>{{ initialAdjustments }}</div>
		<div>{{ currentAdjustments }}</div>
	</div>
</template>
