<template>
  <div class="page-grid">
    <div id="sidebar" class="sidebar-position sidebar">
      ...
      <router-link
        :to="{name: 'admin.users'}"
        :class="{'currentLink' : (activePage === 'users')}"
      >Users</router-link>
      <router-link
        :to="{name: 'admin.experiments'}"
        :class="{'currentLink' : (activePage === 'experiments')}"
      >Experiments</router-link>
      <router-link
        :to="{name: 'admin.curriculums'}"
        :class="{'currentLink' : (activePage === 'curriculums')}"
      >Curriculums</router-link>
      <router-link
        :to="{name: 'admin.ressources'}"
        :class="{'currentLink' : (activePage === 'ressources')}"
      >Ressources</router-link>
      <router-link
        :to="{name: 'admin.data'}"
        :class="{'currentLink' : (activePage === 'data')}"
      >Data</router-link>
      <router-link
